        ...
        <section id="catalog">
            ...
            <div class="search-container">
                <div class="search-box">
                    ...
                    <button class="search-btn" onclick="performSearch()">ðŸ”</button>
                </div>
            </div>
        ...
        <section id="adminPanel" class="admin-panel hidden">
            ...
            <div class="admin-search-container">
                ...
                <div class="search-box">
                    ...
                    <button class="search-btn" onclick="adminFilterProducts()">ðŸ”</button>
                </div>
            </div>
...
def init_db():
    ...
    if not c.fetchone()[0]:
        sample_products = [
            ("Premium Cotton Shirt", 29.99, "static/images/shirt1.jpg", "Comfortable 100% cotton shirt", "shirts"),
            ("Wireless Headphones", 89.99, "static/images/wireless headphone1.jpg", "Premium sound quality", "electronics"),
            ("Running Shoes", 79.99, "static/images/shoe1.jpg", "Lightweight running shoes", "shoes"),
             ("Running Shoes", 79.99, "static/images/shoe2.jpg", "Lightweight running shoes", "shoes"),
            ("Leather Wallet", 39.99, "static/images/wallet1.jpg", "Genuine leather wallet", "accessories"),
            (" T-Shirt", 24.99,"static/images/tshirt1.jpg", "Cool graphic tee", "shirts"),
        ]
